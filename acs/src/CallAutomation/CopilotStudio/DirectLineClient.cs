...
namespace CopilotStudio
{
    public class DirectLineClient : DirectLineClientBase
    {
        ...
        public async Task SendActivityAsync(Activity activity, CancellationToken cancellationToken = default)
        {
            try
            {
        ...
        public async Task<List<Activity>> ReceiveActivitiesAsync(CancellationToken cancellationToken = default)
        {
